...
import Line_graph_q1 from './Line_graph_q1.JPG';
import Line_graph_q2 from './Line_graph_q2.JPG';
import Pie_Chart_q1 from './Pie_Chart_q1.JPG';
import Pie_Chart_q2 from './Pie_Chart_q2.JPG';
import map_q1 from './map_q1.JPG';
    ...
    return (
      <div>
        <IeltsSampleWritingstyle
          ...
          question_heading_2='The chart below shows the changes that took place in three different areas of crime in Panama City from 2010 to 2019. Summarise the information by selecting and reporting the main features, and make comparisons where relevant.Write at least 150 words.'
          img_1={Line_graph_q1}
          img_2={Line_graph_q2}
          answer='Answers'
    ...
    return (
      <div>
        <IeltsSampleWritingstyle
          ...
          question_heading_2='The pie charts below show the spending of a school in the UK from 1981 to 2001.Summarise the information by selecting and reporting the main features, and make comparisons where relevant.Write at least 150 words.'
          img_1={Pie_Chart_q1}
          img_2={Pie_Chart_q2}
          answer='Answers'
          ...
          para5='The two pie charts illustrate the differences between expenses spent in a school in the UK in three different years 1981,1991 and 2001.'
          para6='Overall, it is clearly apparent that school spent the highest amount of money on the salary of teachers in all the years given, while on the contrary, least amount of money had been spent on the insurance for 3 years.'
          para7='The salary of other staff was more than a quarter in the initial year, which modestly declined to 22% in 1991 before gradually decreasing further more by 7% in 2001.In contrast, expenses made on the insurance was only 2% in the starting year, which marginally rose by 1% in 1991 followed by another 5% increment in 2001.'
          para8='On the other hand, the expenditure spent on salary of teachers was 40% in 1981 which rose to half of the total after ten years before getting dwindled by 5% in 2001.Similarly, expenses made on ressources like books was 15% in the first year before getting increased to one fifth in 1991, followed by sudden dip to 9% in 2001.Moreover, the amount of money spent on furniture and other equipments was 15% in 1981, which subsequently fell down by 10% in 1991, and ultimately it outstandingly elevated to 23% in 2001.'
        />
      </div>
    );
    ...
    return (
      <div>
        <IeltsSampleWritingstyle
          ...
          question_heading_2='The graph below shows the percentage of part-time workers in each country of the United Kingdom in 1980 and 2010. Summarise the information by selecting and reporting the main features, and make comparisons where relevant.Write at least 150 words.'
          img_1={Bar_graph_q1}
          img_2={Bar_graph_q2}
          answer='Answers'
          ...
          para5='The bar chart shows the percentage of people who have part-time jobs in the countries that make up the United Kingdom, both in 1980 and in 2010.'
          para6='Overall, there has generally been a small increase in part-time workers from 1980 to 2010, except in Northern Ireland. The graph also shows that England and Wales have far more part-time workers than Northern Ireland and Scotland.'
          para7='In 1980, 25% of people in England worked part time. The only country with a greater percentage of part-time workers was Wales, with around 33% working part time. Both countries saw an increase in the percentage of people working part time in 2010. In England, the percentage rose to over 30% and in Wales percentage rose to just over 35%.'
          para8='Scotland had the smallest percentage of part-time workers in 1980, with just over ten per cent. However, this rose to almost 20% in 2010 which is a large increase. Lastly, Northern Ireland was the only country which had a decreasing percentage of part-time workers. In 1980, it had around 15% of people in part-time work. This decreased by a couple of per cent in 2010.'
        />
      </div>
    );
  } 
    ...
    return (
      <div>
        <IeltsSampleWritingstyle
          ...
          question_heading_2='The table below gives information about the employment sectors in which people from 3 age groups worked.Write at least 150 words.'
          img_1={Table_q1}
          img_2={Table_q2}
          answer='Answers'
    ...
    return (
      <div>
        <IeltsSampleWritingstyle
          ...
          question_heading_2='The maps below show the changes that have taken place at Queen Mary Hospital since its construction in 1960.Summarise the information by selecting and reporting the main features, and make comparisons where relevant.Write at least 150 words.'
          img_1={map_q1}
          img_2={map_q2}
          answer='Answers'
          ...
          para5='The maps illustrate how Queen Mary hospital has developed since 1960 when it was built originally.'
          para6='Overall, the hospital saw a significant growth although some facilities for shopping and land for farming did not develop as much as cancer centres.'
          para7='In 1960, the hospital and the shopping centre were the only two buildings located along the main road.There was a large parking area for cars which was situated right behind the hospital and to the right of some farmland.Twenty years later in 1980, the shopping centre was demolished and replaced by a centre regarding cancer, as well as a block of pharmacy was joined with the hospital.Likewise, the farmland was also replaced by the school for nursing, but the car park remained unchanged.'
          para8='In 2000, the cancer centre expanded, as a result of which the land previously allocated to nursing school was added to it.However, the area for the car parking along with the nursing school dwindled from the original size.'
        />
      </div>
    );
    ...
    return (
      <div>
        <IeltsSampleWritingstyle
          ...
          question_heading_2='The diagrams below give information about the manufacture of frozen fish pies. Summarise the information by selecting and reporting the main features, and make comparisons where relevant.Write at least 150 words.'
          img_1={process_q1}
          img_2={process_q2}
          answer='Answers'
